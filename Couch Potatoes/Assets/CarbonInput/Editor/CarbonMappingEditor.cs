...
namespace CarbonInput {
    ...
    public class CarbonMappingEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            string regex = EditorGUILayout.TextField("RegEx", mapping.RegEx);
            ...
            EditorGUI.BeginChangeCheck();
            int priority = EditorGUILayout.IntField("Priority", mapping.Priority);
            if(EditorGUI.EndChangeCheck()) {
	        ...
	        EditorGUI.BeginChangeCheck();
	        bool useOnce = EditorGUILayout.Toggle("Use Once", mapping.UseOnce);
	        if(EditorGUI.EndChangeCheck()) {
